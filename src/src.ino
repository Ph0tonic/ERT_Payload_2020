...
enum State_enum {s_OFF, s_IDLE, s_STANDBY, s_INJECTED, s_READY, s_RECORDING, s_FLYING, s_LANDED};
enum SignalRF_enum {NONE, GET_STATE, SHUTDOWN, WAKE, INJECT, BYPASS_INJECT, REC, ABORT};
...
uint8_t state = s_OFF;
time_t timer_liftoff = 0, elapsed_time = 0;
